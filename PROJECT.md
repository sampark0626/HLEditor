...
4. **stream-copy 분기** — 속도 우선 모드 옵션화
5. **타임스탬프 자막/번호** — 각 클립에 원본 경기 시각 burn-in (어느 장면인지 추적용)
6. **STT 보조 신호** — 현장음에 "골!" 등 명확한 외침이 있으면 보조 점수로 활용 (동호회 웅성거림이라 인식률 낮을 수 있어 우선순위 낮음)
